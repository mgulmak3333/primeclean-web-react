...
function Header(){
    ...
    const navOpen = useRef<HTMLAnchorElement>(null);
    const navClose = useRef<HTMLAnchorElement>(null);
                ...
                <div ref={navHeader} className='heads'>
                    <div className="container d-flex align-items-center justify-content-between">
                        ...
                        <div className="mobil-ico text-decoration-none">
                            <a ref={navOpen} className='open-i' href="#">
                            ...
                            <a ref={navClose} className='close-i' href="#">
